...
<Modal>
  <div class="tw-flex tw-flex-col tw-max-w-[500px] tw-w-full tw-bg-white tw-rounded-md tw-shadow-md tw-p-3 tw-gap-2">
    <div class="tw-flex tw-justify-center tw-relative">
      ...
      <div class="tw-absolute tw-right-0 tw-pr-[16px] tw-cursor-pointer" on:click={() => $changeProfilePic = false}>
        <Close width={24} height={24} />
      </div>
    </div>
    <hr />
    <form on:submit={handleChangeProfilePic}>
      <div class="tw-flex tw-flex-col tw-gap-5">
        ...
        {:else}
          <div class="tw-w-full tw-rounded-md tw-border-[1px] tw-border-gray-400 tw-p-2 tw-relative tw-items-center">
            <img src={URL.createObjectURL(photo)} width={450} height={221} class="tw-w-full tw-bg-gray-100 tw-rounded" alt="Chosen" />
